...
describe("plugins/leaderboards/actions/updateRow", () => {
    ...
    describe("handleAction()", () => {
        ...
        it("should return an error if the new row already exists", async () => {
            ...
            jest.spyOn(Rows, "getRow").mockReturnValueOnce(Promise.resolve(mockRow)).mockReturnValueOnce(Promise.resolve(mockNewRow));
        ...
        it("should return a success message when updating a row", async () => {
            ...
            jest.spyOn(Rows, "getRow").mockReturnValueOnce(Promise.resolve(mockRow)).mockReturnValueOnce(Promise.resolve(null));
